...
const ProfileSettings = () => {
  ...
  return (
    <div className="settings-panel">
      ...
      <hr style={{ margin: '40px 0 30px 0', border: 'none', borderTop: '1px solid var(--border-color)' }} />
      
      <div className="danger-zone">
        <h3 style={{ color: '#ff4d4d', marginBottom: '10px', fontSize: '1.2rem' }}>Excluir Conta Permanentemente</h3>
        ...
        {deleteMsg.text && (
          <div style={{
            ...
            marginBottom: '20px',
            borderRadius: '4px',
            backgroundColor: deleteMsg.type === 'error' ? 'rgba(255, 77, 77, 0.1)' : 'rgba(77, 255, 136, 0.1)',
        ...
        {!showConfirmDelete ? (
          <button type="button" className="btn-action" style={{ color: '#ff4d4d', borderColor: '#ff4d4d' }} onClick={handleDeleteClick}>
            Desejo excluir minha conta
          </button>
        ) : (
          <div className="danger-confirm-box" style={{ background: 'var(--bg-input)', padding: '20px', borderRadius: 'var(--radius-md)', border: '1px solid #ff4d4d' }}>
            ...
            <input
              ...
              className="auth-input"
              style={{ marginBottom: '15px', maxWidth: '300px', display: 'block', padding: '10px', border: '1px solid var(--border-color)', borderRadius: 'var(--radius-sm)', background: 'var(--bg-surface)', color: 'var(--text-primary)' }}
              disabled={isDeleting}
            />
            <div style={{ display: 'flex', gap: '15px', flexWrap: 'wrap' }}>
              <button 
                ...
                style={{ backgroundColor: '#ff4d4d', color: '#000', border: 'none', fontWeight: 'bold' }}
